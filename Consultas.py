class consultas:
    unificada = """SELECT z01_radicacion_juzgado AS JUZGADO,z01_radicacion_z01_radicacion AS RADICACION,demandante,demandado,clase_proceso AS PROCESO,fecha_ingreso AS FECHA,sincronizado AS SYNC,digitador,ciudad 
                FROM z04_estado  
                WHERE 
                        #FECHA A REVISAR
                        ...
                        OR ((z01_radicacion_z01_radicacion NOT BETWEEN "195000000" AND "202299999") AND z01_radicacion_z01_radicacion NOT LIKE ("%0001"))
